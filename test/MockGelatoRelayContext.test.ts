...
// import { Signer, formatBytes32String, SigningKey, joinSignature } from "ethers";
...
// const correlationId = formatBytes32String("CORRELATION_ID");
...
//     await setBalance(gelatoDiamondOwnerAddress, ethers.parseEther("1"));
...
//     const esKey = new SigningKey(EXEC_SIGNER_PK);
//     const csKey = new SigningKey(CHECKER_SIGNER_PK);
//     const digest = generateDigestRelayContext(msg, domainSeparator);
//     const executorSignerSig = joinSignature(esKey.signDigest(digest));
//     const checkerSignerSig = joinSignature(csKey.signDigest(digest));
